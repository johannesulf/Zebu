...
SOURCE_Z = {
    'des': np.array([0.30, 0.48, 0.71, 0.88]),
    'hsc': np.array([0.44, 0.75, 1.04, 1.30]),
    'kids': np.array([0.23, 0.39, 0.53, 0.75, 0.94])}
LENS_Z = {
    'bgs': np.array([0.15, 0.25, 0.34]),
    'lrg': np.array([0.50, 0.72])}
